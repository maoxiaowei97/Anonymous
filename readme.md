# LaEx: The First Comprehensive Last-mile Express Dataset from Industry
## 1 Abstract
...
### 3.1 LaEx-P
![image](./img/datafeild_LaEx-P.png)


### 3.2 LaEx-D
![image](./img/datafeild_LaEx-D.png)

## 4 Code
Code for tasks on Cainiao-LaEx (Last-mile Delivery dataset).
